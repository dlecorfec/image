...
// writeSOF writes the Start Of Frame marker.
func (e *encoder) writeSOF(marker byte, size image.Point, nComponent int) {
...
func Encode(w io.Writer, m image.Image, o *Options) error {
	...
	if o == nil || !o.Progressive {
		e.writeBaseline(m, b, nComponent)
	} else {
...
func (e *encoder) writeBaseline(m image.Image, b image.Rectangle, nComponent int) {
	// Write the image dimensions.
	e.writeSOF(sof0Marker, b.Size(), nComponent)
...
func (e *encoder) writeProgressive(m image.Image, b image.Rectangle, nComponent int) {
	// Write the image dimensions.
	e.writeSOF(sof2Marker, b.Size(), nComponent)
	// Write the Huffman tables.
	e.writeDHT(nComponent)
	// Write the image data.
